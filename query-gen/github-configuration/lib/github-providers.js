    ...
    return new Promise((resolve, reject) => {
        fetch
            ...
            if (res.status === 200) {
                ...
                throw new Error("Unauthorized GitHub API call. Did you provide a valid GitHub access token?");
            }
            else {
                throw new Error(`Unsuccessful GitHub API call. Status: ${res.status} ${res.statusText}`);
            }
        })
            .then((json) => {
            if ("errors" in json) {
...
function randomBm() {
    ...
    if (num > 1 || num < 0)
        return randomBm(); // Resample between 0 and 1
    return num;
}
/**
...
function extractGhsaIds(data) {
    return data.securityAdvisories.nodes.map((node) => {
        return node.ghsaId;
    });
}
exports.extractGhsaIds = extractGhsaIds;
    ...
    return new Promise((resolve, reject) => {
        ...
        Promise.all([
            ...
            function getRandomMarketplaceCategorySlug() {
                return marketplaceCategorySlugs[Math.floor(Math.random() * marketplaceCategorySlugs.length)];
            }
            function getRandomMarketplaceListingSlug() {
                return marketplaceListingSlugs[Math.floor(Math.random() * marketplaceListingSlugs.length)];
            }
            ...
            function getRandomCodeOfConductKey() {
                return codeOfConductKeys[Math.floor(Math.random() * codeOfConductKeys.length)];
            }
            ...
            function getRandomRepositoryName(existingVars) {
                ...
                if (userLoginKey) {
                    ...
                    return (_a = userRepos.find((repo) => repo.userlogin === userLogin)) === null || _a === void 0 ? void 0 : _a.repository;
                }
                ...
                if (organizationKey) {
                    ...
                    return (_b = orgRepos.find((repo) => repo.organization === organization)) === null || _b === void 0 ? void 0 : _b.repository;
                }
                ...
                if (ownerKey) {
                    ...
                    return (_c = allRepos.find((repo) => repo.userlogin === owner ||
                        repo.organization === owner)) === null || _c === void 0 ? void 0 : _c.repository;
                }
...
//# sourceMappingURL=github-providers.js.map