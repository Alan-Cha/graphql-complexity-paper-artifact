...
var editedAst = graphql_1.visit(ast, {
    ...
    FieldDefinition: {
        enter: function (node, key, parent, path, ancestors) {
            ...
            if (!scalarNames.includes(typeName) && // list of non-scalar types
...
fs.writeFileSync("./configurations/graphql-validation-complexity/graphql-validation-complexity_github.graphql", graphql_1.print(editedAst));
